package com.kalanblow.school_management.infrastructure.web.controller.student;
...
import com.kalanblow.school_management.application.usecase.student.*;
    ...
    public ResponseEntity<PageResponse<StudentResponse>> getAll(
        ...
        StudentPageCacheKey cacheKey =
                new StudentPageCacheKey(
                        page,
                        size,
                        StringNormalizer.normalize(firstName),
                        StringNormalizer.normalize(lastName),
                        classId
                );
